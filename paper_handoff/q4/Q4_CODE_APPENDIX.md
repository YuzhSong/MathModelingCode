# Q4 Complete Code Appendix

This appendix is generated from the current Q4 final runner dependency closure, plus the thin final wrapper. Each section contains the complete source; historical W0-W8 policies and benchmark scripts are excluded.

## run_q4_final.py

Role: final-runner dependency in 25P-PFRC / W6-25PFR.
...
from q4.w6_policy import W6PersistentBearingPolicy, FINAL_STRATEGY_NAME


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Clean Q4 final runner: W6-25PFR, official simulator API."
    )
    ...
    parser.add_argument("--log", default="logs/q4_final_api.jsonl")
...
def main() -> int:
    ...
    client = SimulatorClient(
        ...
        request_ids=RequestIdFactory("q4-w6-25pfr"),
        logger=api_logger,
        run_logger=run_logger,
    )

    policy = W6PersistentBearingPolicy(OfficialClientRunnerAdapter(client))
    policy.run()
    print("Q4 final W6-25PFR run complete.")
