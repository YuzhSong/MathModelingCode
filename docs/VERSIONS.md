...
| V4 | Frozen comparison baseline | V3 | 2026-09-11 00:00 | 2026-09-12 00:00 | Rolling dynamic routing and post-episode oracle benchmarks | `q3.offline_policy.policy_v4` (offline); official adapter remains available | 100% in recorded offline suites | No; comparison | Frozen snapshot: `frozen/v4_n8_20260911/` |
...
| V6 | Final frozen candidate; paper name RARC | V4 | 2026-09-12 00:00 | 2026-09-13 00:00 | Route-aware FOUND-source supplement generation using frozen V4 route marginal cost | `q3.v6_policy.policy_v6` (offline); `main.py --mode official --strategy v6` / `q3.v6_policy.policy_v6_official` (practice-gated) | 100% clear; Mean total 3496.69s; Mean(T/N) 278.69s/source; P95 4244.83s | **Yes** | Snapshot: `frozen/v6_n8_20260912/`; no saved official raw result found |
