...
| Q4 final frozen | `q4/w6/feasible_region_full`, `q4/final_documentation` | W6-25PFR/25P-PFRC validation and paper data |
...
Q4 最终归档入口：[docs/q4_final/README.md](q4_final/README.md)。最终结果索引：[Q4_FINAL_INDEX.md](../results/Q4_FINAL_INDEX.md)。
